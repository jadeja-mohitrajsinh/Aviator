...
<body>
   ...
   ?>
    ...
    <section class="hero-cover">
        <img class="image-block__hero" src="asset/img/MAIN/hero-main.webp" alt="" draggable="false" />
    ...
    <br />
    <section>
        <div id="carouselExampleIndicators" class="carousel slide main" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="asset/img/G800/v_g800_a_mkt_007_Desktop.webp" class="d-block w-100" alt="Slide 1"
                        data-bs-interval="3000" draggable="false" />
                </div>
                <div class="carousel-item">
                    <img src="asset/img/G700/post_d_g700_g_print_00033_desktop.webp" class="d-block w-100" alt="Slide 2"
                        data-bs-interval="3000" draggable="false" />
                </div>
                <div class="carousel-item">
                    <img src="asset/img/G400/post_v_g400_a_mkt_008_desktop.webp" class="d-block w-100" alt="Slide 3"
                        data-bs-interval="5000" draggable="false" />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 order-md-5 container-img text-md-end">
                    <div class="container-img text-lg-end">
                        <img src="asset/img/G800/Cabin_R6__S1_Single Seat_Desktop.webp" alt="Image Alt Text"
                            draggable="false" />
                    </div>
                </div>
                <div class="col-md-6 order-md-4 container-text">
                    <div class="text text-start m-2">
                        <h1>Unparalleled Luxury</h1>
                        <p>
        ...
        <div class="container" style="max-width: 100%">
            <div class="row">
                <div class="col-md-6 order-md-2 container-img">
                    <div class="container-img text-lg-end">
                        <img src="asset/img/G800/Cabin_R10__S1_FWD-AFT_Desktop.webp" alt="Another Image Alt Text"
                            draggable="false" />
                    </div>
                </div>
                <div class="col-md-6 order-md-3 container-text">
                    <div class="text text-end m-2">
    ...
    <section class="section">
        <div class="container" style="max-width: 100%">
            <div class="row">
                <div class="col-md-6 order-md-6 margin-0">
                    <div class="container-img">
                        <img src="asset/img/MAIN/cro_20190726_064_50_370x230@2x.webp" alt="Another Image Alt Text"
                            draggable="false" />
                    </div>
                </div>
